...
DEV_REQUEST_GUIDANCE = (
    ...
    "to file a structured change request with the development team. First use "
    "action='projects' to discover configured destinations, then explicitly set "
    "'project' to one of those names. Submit one project per request; separate "
    "cross-project changes into separate requests. Blank project means open-manus; "
    "unknown names will not fall back to it. Owner approval is still required. Write the "
