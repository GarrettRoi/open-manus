...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("charter", "Show or manage this agent's persistent goal charter and owner questions", "Session",
               gateway_only=True,
               args_hint="[status | pause | resume | phase <discovery|execution> | set <objectives> | questions | answer <id> <text>]",
               subcommands=("status", "pause", "resume", "phase", "set", "questions", "answer")),
    ...
    CommandDef("voice-character", "List or swap the ElevenLabs speaking voice", "Configuration",
               args_hint="[list|<number|name|voice_id>]", subcommands=("list",)),
